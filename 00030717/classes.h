...
enum parameters {TAU,KA,DELTA,LAMBDA,ETA,EXTERNAL_FORCE_X,EXTERNAL_FORCE_Y};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float k, float delta,float lambda, float eta, float p_x, float p_y){
            parameters[TAU]=tau;
            parameters[KA]=k;
            parameters[DELTA]=delta;
            parameters[LAMBDA]=lambda;
            parameters[ETA]=eta;
            parameters[EXTERNAL_FORCE_X]=p_x;
            parameters[EXTERNAL_FORCE_Y]=p_y;
